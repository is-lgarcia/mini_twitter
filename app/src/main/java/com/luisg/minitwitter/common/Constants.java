...
public class Constants {
    ...
    public static final String API_MINITWITTER_PHOTO_URL = "https://www.minitwitter.com:3001/apiv1/uploads/photos";
    public static final String CODE_ACCES_API = "UDEMYANDROID";
